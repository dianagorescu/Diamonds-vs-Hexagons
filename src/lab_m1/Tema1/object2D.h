...
namespace object2D
{
    ...
    Mesh* CreateRomb(const std::string& name, glm::vec3 leftBottomCorner, float length, glm::vec3 color, bool fill = false);
    ...
    Mesh* CreateHeart(const std::string& name, glm::vec3 bottomPoint, float size, glm::vec3 color, bool fill = false);
